/**
 * src/pages/admin/admin-database.tsx
...
const LazyAdminDatabasePanel = lazy(() =>
  import("@/components/octopus-market/admin-database-panel").then((m) => ({
    default: m.AdminDatabasePanel,
  }))
);
...
export function AdminDatabasePage() {
  ...
  return (
    <Suspense fallback={<Card><CardContent className="p-6">Loading database...</CardContent></Card>}>
      <LazyAdminDatabasePanel walletAddress={wallet.walletAddress} />
    </Suspense>
  );
}
